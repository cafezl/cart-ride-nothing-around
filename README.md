...
- `Nothrilo.lua`: versão atual protegida.
- `Nothrilo-key-gratis.lua`: espelho da versão atual com key grátis.
- `Nothrilo-classico-funcoes-corrigidas.lua`: versão clássica legível, com as funções corrigidas.
